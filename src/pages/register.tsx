...
export const ProfileSuccessful = (user: {email: string, username:string}) => {
    ...
    <Wrapper>
      ...
      {({values, errors, touched, handleSubmit, isSubmitting }) => (
          <Form onSubmit={handleSubmit} method="post">
            ...
            <Button disabled={isSubmitting} size='small' variant='outlined' >Register</Button>
        </Form>
        )}
      </Formik> 
      <Text>Already have an account? <Link href='/login'>Login now.</Link></Text>
    </Wrapper>
  );
};
